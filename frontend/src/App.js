      ...
      <nav className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="flex space-x-6">
            {['dashboard', 'production', 'orders', 'users', 'categories', 'invoices', 'purchase-orders', 'settings'].map(tab => (
              <button
                key={tab}
            ...
            {stats && (
              <>
                <div className="bg-white p-6 rounded-lg shadow">
                  ...
                  <p className="text-3xl font-bold" style={{ color: settings?.primary_color }}>{stats.production.total_items_today}</p>
                  <p className="text-sm text-gray-600">Total Items</p>
                </div>
                <div className="bg-white p-6 rounded-lg shadow">
                  <h3 className="text-lg font-semibold text-gray-800">Completed</h3>
                  <p className="text-3xl font-bold" style={{ color: settings?.accent_color }}>{stats.production.completed_items_today}</p>
                  <p className="text-sm text-gray-600">Items Done</p>
                </div>
                <div className="bg-white p-6 rounded-lg shadow">
                  <h3 className="text-lg font-semibold text-gray-800">Daily Revenue</h3>
                  <p className="text-3xl font-bold text-green-600">${stats.orders.daily_revenue?.toFixed(2) || '0.00'}</p>
